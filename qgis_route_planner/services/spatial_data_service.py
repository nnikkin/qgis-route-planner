...
from ..exceptions import TopologyBuildError, DbConnectionError, DataImportError
...
class SpatialDataService:
    ...
    def run_init_database(self, layers: list[Layer], column_mapping=None):
        ...
        try:
            ...
            raise DbConnectionError(
                "Произошла ошибка при инициализации типов ограничений",
        ...
        try:
            ...
            raise DbConnectionError(
                "Произошла ошибка при создании таблиц профилей ТС",
                operation="run_init_database"
            ) from e